...
export async function planner(ns, target, host)
{
  ...
  return {
    ...
    chance: formulas.calculateHackingChance(targetServer, player),
    money: formulas.calculatePercentMoneyHacked(targetServer, player),
    time: formulas.calculateHackingTime(targetServer, player)
  };
}
